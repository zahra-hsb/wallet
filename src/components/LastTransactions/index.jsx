                                ...
                                <div className="w-full flex flex-col items-center gap-2 justify-around border-b p-5">
                                    ...
                                    <div key={index} className="w-full flex justify-around gap-5">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <button onClick={() => decline(item._id)} className={`py-1 px-6 border rounded-full text-center  ${item.status === 'approve' || item.status === 'decline' ? `bg-gray-500 cursor-not-allowed` : `shadow-red border-[#FD625E]`}`} disabled={item.status === 'approve' || item.status === 'decline' ? true : false} >decline</button>
                                        </div>
                                    </div>
                                </div>
                            </>
